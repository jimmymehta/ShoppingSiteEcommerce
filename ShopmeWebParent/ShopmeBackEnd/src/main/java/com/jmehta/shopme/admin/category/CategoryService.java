package com.jmehta.shopme.admin.category;
...
public class CategoryService {
	...
	private List<Category> listHeirarchicalCategories(List<Category> rootCategories, String sortDir) {
		...
		for (Category rootCategory : rootCategories) {
			...
			Set<Category> children = sortChildCategories(rootCategory.getChildren(), sortDir);
			...
			for (Category subCategory : children) {
				...
				listSubHierarchicalCategories(heirarchicalCategories, subCategory, 1, sortDir);
			}
	...
	private void listSubHierarchicalCategories(List<Category> hierarchicalCategories, Category parent, int subLevel,
		...
		Set<Category> children = sortChildCategories(parent.getChildren(), sortDir);
	...
	public List<Category> listCategoryUsedInForm() {
		...
		List<Category> categoriesInDB = (List<Category>) categoryRepo.findRootCategories(Sort.by("name").ascending());
	...
	private SortedSet<Category> sortChildCategories(Set<Category> children, String sortDir) {
