...
import com.jmehta.shopme.admin.product.ProductService;
...
public class ProductSearchController {
	...
	public String searchProductsByPage(@PagingAndSortingParam(listName = "listProducts", moduleURL = "/orders/search_product") 
