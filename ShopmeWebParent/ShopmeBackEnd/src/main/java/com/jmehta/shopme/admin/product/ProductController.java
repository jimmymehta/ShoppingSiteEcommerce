...
import com.jmehta.shopme.admin.brand.BrandService;
import com.jmehta.shopme.admin.category.CategoryService;
import com.jmehta.shopme.admin.paging.PagingAndSortingHelper;
import com.jmehta.shopme.admin.paging.PagingAndSortingParam;
import com.jmehta.shopme.admin.security.ShopmeUserDetails;
	...
	public String saveProduct(Product product, RedirectAttributes ra,
		...
		if(!loggedUser.hasRole("Admin") && !loggedUser.hasRole("Editor")) {
			...
			if(loggedUser.hasRole("Salesperson")) {
				...
				ra.addFlashAttribute("message", "The product has been successfully.");
		...
		//main image change save
		ProductSaveHelper.setMainImageName(mainImageMultipart, product);
		
		//any changes in existing extra images
		ProductSaveHelper.setExistingExtraImageNames(imageIDs, imageNames, product);
		
		// if user upload new extra image
		ProductSaveHelper.setNewExtraImageNames(extraImageMultiparts, product);
		
		// changes related to product details
