...
import com.jmehta.shopme.common.entity.order.OrderTrack;
...
public class OrderRepositoryTests {
	...
	public void testUpdateOrderTrack() {
		...
		OrderTrack newProcessingTrack = new OrderTrack();
		newProcessingTrack.setOrder(order);
		newProcessingTrack.setUpdatedTime(new Date());
		newProcessingTrack.setStatus(OrderStatus.PACKAGED);
		newProcessingTrack.setNotes(OrderStatus.PACKAGED.defaultDescription());
		
		List<OrderTrack> orderTracks = order.getOrderTracks();
		orderTracks.add(newTrack);
		orderTracks.add(newProcessingTrack);
