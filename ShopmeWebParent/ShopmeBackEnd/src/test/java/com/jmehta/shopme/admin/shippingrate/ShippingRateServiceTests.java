...
import com.jmehta.shopme.admin.product.ProductRepository;
...
public class ShippingRateServiceTests {
	...
	@Test
	public void calculateShippingCost_NoRateFound() {
	...
	@Test
	public void calculateShippingCost_RateFound() throws ShippingRateNotFoundException {
